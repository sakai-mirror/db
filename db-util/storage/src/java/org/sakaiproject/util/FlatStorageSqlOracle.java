...
public class FlatStorageSqlOracle extends FlatStorageSqlDefault 
{
   ...
   public String getSelectFieldsSql1(String table, String fieldList, String idField, String sortField1, String sortField2, int begin, int end) {
      return "select * from (select " + fieldList + " , RANK() OVER (order by " + table + "." + sortField1 + (sortField2 == null ? "" : "," + table + "." + sortField2) + "," +
               table + "." + idField + ") as rank from " + table + " order by " + table + "." + sortField1 + (sortField2 == null ? "" : "," + table + "." + sortField2) + "," +
               table + "." + idField + ") where rank between ? and ?";
   }
   ...
   public String getSelectFieldsSql3(String table, String fieldList, String idField, String sortField1, String sortField2, int begin, int end, String join, String where, String order) {
      return "select * from (select " + fieldList + " ,RANK() OVER (order by " + order + "," + table + "." + idField + ") as rank" + " from " + table +
